...
The application itself (use `shiny::runApp()` from the cloned repository or open the <a href="http://193.146.75.235/sample-apps/final_apps/ine_download/"  rel="noopener noreferrer" target="_blank">online version</a> in a new window) pursues the goal to allow users to consult the contents, retrieve and visualize the data in an easy-to-manipulate manner. 
